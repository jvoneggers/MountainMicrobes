...
#create another column in the metadata with factored sample_type. This is because sample type and sample id dissapears when summing samples within sites.
...
sample_data(ps.merged.by.site)$sample_type_merged <- as.character(to_change$sample_type_merged)
...
plot_bar(ps.merged.by.site.kingdom, fill = "Kingdom", title = "Merged samples by site") + 
  ...
  theme(plot.title = element_text(hjust=0.5, size=20), 
        ...
        axis.text.x = element_text(size=0.1, vjust=0.5),
