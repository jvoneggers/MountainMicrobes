...
#write.csv(esv_to_normalize_10k, paste0("ZOTU/",Sys.Date(),"_ZOTUexact_ESVs_to_normalize_10K_reads.csv"), row.names=T)
write.csv(esv_tab_10knorm, paste0("ZOTU/",Sys.Date(),"_ZOTUexact_ESV_tab_10K_reads_normalized.csv"), row.names=T)
